...
var AwsKmsStrategy = class {
  ...
  async encrypt(keyId, plaintext, context3) {
  ...
  async decrypt(keyId, ciphertext, context3) {
...
var GcpKmsStrategy = class {
  ...
  async encrypt(keyId, plaintext, context3) {
    const [result] = await this.retry(() => this.client.encrypt({
      ...
      plaintext: typeof plaintext === "string" ? Buffer.from(plaintext) : plaintext,
      additionalAuthenticatedData: context3 ? Buffer.from(JSON.stringify(context3)) : void 0
    }));
    return {
  ...
  async decrypt(_keyId, ciphertext, context3) {
