...
var import_node_process5, import_node_os4, import_node_fs3, isWsl, is_wsl_default;
var init_is_wsl = __esm({
  "../../node_modules/is-wsl/index.js"() {
    ...
    is_wsl_default = import_node_process5.default.env.__IS_WSL_TEST__ ? isWsl : isWsl();
  }
});

// ../../node_modules/wsl-utils/index.js
var import_node_process6, import_promises, wslDrivesMountPoint, powerShellPathFromWsl, powerShellPath;
var init_wsl_utils = __esm({
  "../../node_modules/wsl-utils/index.js"() {
    ...
    powerShellPath = async () => {
      ...
      return `${import_node_process6.default.env.SYSTEMROOT || import_node_process6.default.env.windir || String.raw`C:\Windows`}\\System32\\WindowsPowerShell\\v1.0\\powershell.exe`;
    };
  }
});
...
var import_node_util3, import_node_process7, import_node_child_process, execFileAsync;
...
var import_node_process8, import_node_util4, import_node_child_process2, execFileAsync2;
...
var import_node_util5, import_node_child_process3, execFileAsync3, windowsBrowserProgIds, _windowsBrowserProgIdMap, UnknownBrowserError;
...
async function defaultBrowser2() {
  ...
  if (import_node_process9.default.platform === "linux") {
...
var import_node_util6, import_node_process9, import_node_child_process4, execFileAsync4, titleize;
...
var import_node_process10, import_node_buffer, import_node_path, import_node_url, import_node_util7, import_node_child_process5, import_promises2, import_meta, execFile5, __dirname, localXdgOpenPath, platform, arch, pTryEach, baseOpen, open, openApp, apps, open_default;
var init_open = __esm({
  "../../node_modules/open/index.js"() {
    "use strict";
    ...
    ({ platform, arch } = import_node_process10.default);
    ...
    baseOpen = async (options) => {
      ...
      if (platform === "darwin") {
        ...
        if (app) {
          ...
          const useSystemXdgOpen = import_node_process10.default.versions.electron ?? (platform === "android" || isBundled || !exeLocalXdgOpen);
...
var AwsSecretsStrategy = class {
  ...
  constructor(config) {
    ...
    this.client = new import_client_secrets_manager.SecretsManagerClient({ region: config.region ?? "us-east-1", ...config.config });
    this.retryConfig = {
  ...
  async getSecret(name3) {
    try {
      const result = await withRetry(() => this.client.send(new import_client_secrets_manager.GetSecretValueCommand({ SecretId: name3 })), this.retryConfig);
      return {
  ...
  async createSecret(name3, value, options) {
    const result = await withRetry(() => this.client.send(new import_client_secrets_manager.CreateSecretCommand({
      Name: name3,
      SecretString: value,
  ...
  async updateSecret(name3, value) {
    const result = await withRetry(() => this.client.send(new import_client_secrets_manager.UpdateSecretCommand({
      SecretId: name3,
      SecretString: value
    })), this.retryConfig);
    return {
  ...
  async deleteSecret(name3, options) {
    await withRetry(() => this.client.send(new import_client_secrets_manager.DeleteSecretCommand({
      SecretId: name3,
  ...
  async listSecrets(options) {
    const result = await withRetry(() => this.client.send(new import_client_secrets_manager.ListSecretsCommand({
...
var GcpSecretsStrategy = class {
  ...
  constructor(config) {
    ...
    this.client = new import_secret_manager.SecretManagerServiceClient(config.config);
...
function computeAdditionalCacheKeyHash(components) {
  ...
  return (0, import_crypto3.createHash)("sha256").update(input, "utf8").digest("base64url");
}
...
var AzureArc = class _AzureArc extends BaseManagedIdentitySource {
  ...
  async getServerTokenResponseAsync(originalResponse, networkClient, networkRequest, networkRequestOptions) {
    ...
    if (originalResponse.status === Constants_exports.HTTP_UNAUTHORIZED) {
      ...
      let secret;
      try {
        secret = (0, import_fs.readFileSync)(secretFilePath, Constants_exports.EncodingTypes.UTF8);
      } catch (e) {
        throw createManagedIdentityError(unableToReadSecretFile, "");
      }
...
var ClientCertificateCredential = class {
  ...
  async buildClientCertificate() {
    ...
    if (this.certificateConfiguration.certificatePassword !== void 0) {
      privateKey = (0, import_node_crypto3.createPrivateKey)({
...
async function parseCertificate(certificateConfiguration, sendCertificateChain) {
  ...
  const thumbprint = (0, import_node_crypto3.createHash)("sha1").update(Buffer.from(publicKeys[0], "base64")).digest("hex").toUpperCase();
  const thumbprintSha256 = (0, import_node_crypto3.createHash)("sha256").update(Buffer.from(publicKeys[0], "base64")).digest("hex").toUpperCase();
  return {
    certificateContents,
    thumbprintSha256,
    thumbprint,
  ...
  async getAzdAccessToken(scopes, tenantId, timeout, claims) {
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        import_child_process.default.exec(command, {
...
var import_node_child_process6 = __toESM(require("child_process"), 1);
var processUtils = {
  /**
  ...
  execFile(file, params, options) {
    return new Promise((resolve, reject) => {
      import_node_child_process6.default.execFile(file, params, options, (error, stdout, stderr) => {
...
var VisualStudioCodeCredential = class {
  ...
  async loadAuthRecord(authRecordPath, scopes) {
    try {
      const authRecordContent = await (0, import_promises5.readFile)(authRecordPath, { encoding: "utf8" });
...
var AzureSecretsStrategy = class {
  ...
  constructor(config) {
    ...
    this.client = new import_keyvault_secrets.SecretClient(this.vaultUrl, credential, config.config);
    this.maxRetries = config.config?.["maxRetries"] ?? 3;
    this.baseDelayMs = config.config?.["baseDelayMs"] ?? 100;
  }
  retry(fn) {
